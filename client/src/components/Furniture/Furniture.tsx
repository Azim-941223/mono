          ...
          <div className={css.ChairBoston}>
            ...
            <div className={css.Left}>
              ...
              <div className={css.Left__button}>
                <button className={css.Left__btn}>
                  <p className={css.Left__basket_text}>{t("basket")}</p>
                  <svg
                    className={css.Left__basket}
                    width="21"
                    height="21"
                    viewBox="0 0 21 21"
                    fill="none"
